            ...
            <tbody>
                {CreditLimitExeedCustomers.map(customer => (
                    <tr key={customer.customerID}>
                        ...
                        <td className="border px-1 py-2"><Link to={`/viewalltransactions/${customer.customerID}`}><button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mr-2">View all Transactions</button></Link> <button className="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded mr-2" onClick={() => hadleBanButton(customer.customerID)} >Ban</button> <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" onClick={() => hadleUnbanButton(customer.customerID)}>Unban</button></td>

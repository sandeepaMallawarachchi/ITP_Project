...
export default function Home() {
    ...
    return (
        ...
        <div className="container mx-auto p-4">
                                ...
                                return (
                                    <tr key={expense.index}>
                                        ...
                                        <td className="border border-gray-400 px-4 py-2">{expense.action}
                                            <button type="button" class="btn btn-secondary btn-lg" onClick={() => handleUpdateExpensesBtn(expense._id, id)}>Update</button>
                                            <button
            ...
            <button className="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded mt-4 ml-64" onClick={handleaddExpenses}>Add Expenses</button>
